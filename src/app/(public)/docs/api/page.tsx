...
const SIDEBAR_ITEMS = [
  ...
  { id: "rate-limiting", label: "Rate Limiting" },
  {
    ...
    children: [
      ...
      { id: "save-link", label: "Save a link" },
      { id: "get-link", label: "Get a link" },
      { id: "update-link", label: "Update a link" },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "delete-key", label: "Delete a key" },
    ],
  },
...
export default function ApiDocsPage() {
  return (
    <div className="w-full flex gap-12 py-12 min-h-screen">
      {/* Sidebar */}
      ...
      {/* Content */}
      <main className="flex-1 min-w-0 max-w-3xl flex flex-col gap-16">
        {/* Page header */}
        <div className="flex flex-col gap-3">
          <Typography variant="h2" component="h1">
            API Reference
          </Typography>
          <Typography className="text-muted-foreground text-lg leading-7">
            The Purl REST API lets you save, read, update, and delete links
            programmatically. All endpoints are authenticated with an API key
            and return JSON.
          </Typography>
        ...
        >
          ...
          <Typography className="text-muted-foreground leading-7">
          ...
          <CodeBlock
            language="http"
            code={`Authorization: Bearer purl_live_xxxxxxxxxxxxxxxxxxxx`}
          />
          <Typography size="small" className="text-muted-foreground">
            API keys are scoped to your account. Keep them secret — do not
        ...
        >
          ...
          <div id="list-links" className="flex flex-col gap-4 scroll-mt-24">
            ...
            <Typography size="small" className="font-medium text-foreground">
              Query parameters
            </Typography>
            <ParamTable
              params={[
  ...
  -H "Authorization: Bearer purl_live_xxxxxxxxxxxxxxxxxxxx"`}
            />
            <Typography size="small" className="font-medium text-foreground">
              Response
            </Typography>
  ...
  "nextCursor": "clxyz122"
          ...
          <div id="save-link" className="flex flex-col gap-4 scroll-mt-24">
            ...
            <Typography className="text-muted-foreground leading-7">
              Saves a URL to your library. Purl automatically detects the
              content type and queues the link for AI processing if your plan
              includes it.
            </Typography>
            <Typography size="small" className="font-medium text-foreground">
              Body
  ...
  -H "Authorization: Bearer purl_live_xxxxxxxxxxxxxxxxxxxx"`}
        ...
        <section id="api-keys" className="flex flex-col gap-12 scroll-mt-24">
          ...
          <div id="list-keys" className="flex flex-col gap-4 scroll-mt-24">
            ...
            <Typography className="text-muted-foreground leading-7">
              Returns all API keys for your account. Key values are never
              returned after creation — only the prefix and metadata.
            </Typography>
            <CodeBlock
              language="curl"
  ...
  -H "Authorization: Bearer purl_live_xxxxxxxxxxxxxxxxxxxx"`}
        ...
        <section
          id="errors"
          className="flex flex-col gap-4 scroll-mt-24 pb-16"
        >
          <Typography
            variant="h3"
            component="h2"
